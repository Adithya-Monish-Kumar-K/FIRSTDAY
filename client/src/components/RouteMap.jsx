    ...
    return (
      <div className="map-placeholder" style={{ height }}>
        <div className="map-placeholder-content">
          ...
          <p className="text-sm" style={{ color: "#ef4444", marginTop: "8px" }}>
            {loadError.message}
          </p>
        </div>
      </div>
      ...
      >
        ...
        {showMarkers && destination && (
          <Marker
            ...
            onClick={() =>
              setSelectedMarker({ type: "destination", ...destination })
            }
          />
        )}
        ...
        {showMarkers &&
          waypoints.map((wp, index) => (
            <Marker
              ...
              onClick={() =>
                setSelectedMarker({ type: "waypoint", index, ...wp })
              }
            />
          ))}
            ...
            (cp, index) =>
              ...
              cp.lng && (
                <Marker
                  ...
                  onClick={() =>
                    setSelectedMarker({ type: "checkpoint", ...cp })
                  }
                />
              )
          )}
          ...
          routes.map((route, index) => (
            <Polyline
              ...
              options={{
                strokeColor:
                  route.color ||
                  TRANSPORTER_COLORS[index % TRANSPORTER_COLORS.length],
                strokeOpacity: 0.8,
                strokeWeight: 5,
              }}
            />
